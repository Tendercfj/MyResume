  ...
  experience: [
    {
      company: "北京小鸦科技有限公司",
      job: "web前端工程师",
      reap: "在这家公司主要负责该公司自营的产品，有官网，知鸦小程序，分销平台，大语文学习平台，H5活动推广，项目的埋点等，陪着公司迅速成长，解决了公司项目过于单一的痛点，解决了项目无法充值，形式过于简单等问题",
      beginTime: "2019-10",
      endTime: "2020-10",
    },
    {
      ...
      list: [
        {
          beginTime: "2019-10",
          endTime: "2020-10",
          proName: "知鸦助手小程序(uni-app)",
          period: "2个月+更新迭代到离职",
          describe:
            "这是一款是一款根据用户喜好，根据投票来决定直播内容的通识产品,后期迭代到打卡，日历，直播等众多新功能",
          science: [
            "运用uni-app进行的小程序开发",
            "运用微信自带api权限给用户提供良好的用户体验以及丰富的功能",
            "运用vuex进行组件数据的传递存储",
            "运用uviewui这款uni-app的组件进行开发",
            "用到<live-player />以及websocket和第三方阿里工具进行直播的开发",
        ...
        },
        {
          ...
          period: "2个月+迭代至今",
          describe:
            "这款项目，是一款将本公司产品分销出去，从而提升销量，分销商争取佣金的一个平台",
          science: [
            "该项目是本人独立开发",
            "该项目模块有:",
            "  -登陆注册修改密码服务协议",
            "  -全部分类搜索，二级分类搜索列表，详情页",
            "  -个人中心模块(分销商品，订单信息，结算管理)",
            "  -支付提现功能模块",
            "  -分销生成的链接自己二维码模块",
            "运用到的技术 vue全家桶和element ui ",
            "对该项目进行了全面的埋点了解用户行为，为后期迭代更新进行研究",
          ],
        },
